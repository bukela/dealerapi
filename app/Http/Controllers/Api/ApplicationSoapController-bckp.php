...
class ApplicationSoapController_bckp extends Controller
{

    public function app_send($id)
    {
...
// dd($application->general->martial_status);
        $soap_request =
        ...
        <AXML xsi:type='xsd:string'>
            ...
            <UserToken>{FD82F1F0-3D7D-480C-A6FC-2A51E7F09C45}</UserToken>
            <Request>
                <Operation>SubmitApplication</Operation>
                <SubmitApp>
                <Application>
                    <AppTypeID>{$application->id}</AppTypeID>
        ...
        $soap_request .= "<AssetSubTypeID>Motorcycle</AssetSubTypeID>
                    ...
                    <usr_VIN></usr_VIN>
                    <Estimated_Equipment_Cost>11740.70</Estimated_Equipment_Cost>
                ...
                $soap_request .= "<usr_CompanyPostal></usr_CompanyPostal>\n" ;
                    !empty($application->employment->telephone) ?
                $soap_request .= "<usr_CompanyTelephone>{$application->employment->telephone}</usr_CompanyTelephone>\n" :
                ...
                $soap_request .= "<CoLessee>Y</CoLessee>\n" ;
                    !empty($application->coapplicant->first_name) ?
